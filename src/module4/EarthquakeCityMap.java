...
public class EarthquakeCityMap extends PApplet {
	...
	private String earthquakesURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/quiz1.atom";
	...
	public void setup() {		
	    ...
	    /*int insideUS = 0, insideChina = 0;
	    for(Marker m: quakeMarkers){
	    	if( (String)m.getProperty("country") == "United States" ) {
	    		insideUS += 1;
	    	} else if( (String)m.getProperty("country") == "China" ) {
	    		insideChina += 1;
	    	}
	    }
	    System.out.println("Total Ocean quakes: " + oceanMarkser);
	    System.out.println("Inside US: " + insideUS);
	    System.out.println("Inside China: " + insideChina);
	    */
	}  // End setup
